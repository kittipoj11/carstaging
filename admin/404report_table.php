           ...
           <div class="container-fluid">
               <div class="row mb-2">
                   <div class="col-sm-6 d-flex">
                       <h4>รายงานจำนวนการจองของรถแต่ละประเภทแยกตามอีเวนต์</h4>
                   </div>
               </div>
           </div><!-- /.container-fluid -->
       </section>
                       ...
                       <div class="card">
                           ...
                           <div class="card-body">
                               <form name="frmReport" id="frmReport">
                                   <div class="d-flex col-12 col-sm-6 p-0 flex-fill mb-2">
                                       <span class="input-group-text">อีเวนต์</span>
                                       <!-- เมื่อมีการกดเลือกรายการอีเวนต์ จะส่งค่า id="open_id" ให้กับ function ในไฟล์ script.js-->
                                       <select name="open_id" id="open_id" class="form-select form-select-sm form-control" data-type="อีเวนต์">
                                           <option value="">...</option>
                                   ...
                                   <div class="d-flex col-12 col-sm-6 p-0">
                                       <div class="d-flex flex-fill mb-2">
                                           <span class="input-group-text">วันที่เปิดจอง:</span>
                                           <input type="date" name="date_start" class="form-control" id="date_start" value="<?php echo date('Y-m-d'); ?>">
                                           <span class="input-group-text">ถึง</span>
                                           <input type="date" name="date_end" class="form-control" id="date_end" value="<?php echo date('Y-m-d'); ?>">
                                       </div>
                                   </div>
